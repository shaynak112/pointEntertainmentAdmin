 ...
 <!-- sidebar menu: : style can be found in sidebar.less -->
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/gallery/addPhotos.php"><i class="fa fa-circle-o"></i>Add Photos</a></li>
            <li><a href="pages/gallery/approvePhotos.php"><i class="fa fa-circle-o"></i>Approve Photos</a></li>
            <li><a href="pages/gallery/updatePhotos.php"><i class="fa fa-circle-o"></i>Update/Delete Photos</a></li>
