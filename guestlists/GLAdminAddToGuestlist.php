...
<h3>Promoters and DJs GL for July 15, Vinyl and Classics</h3>
...
<p>Add based on any emails that promoters or DJs have sent you</p>
<p>Add "comp" in brackets after guestName (or before, whatever is best for you), if that is difficult then we can organize another way, but I don't think we need another column for the few comps we get?</p>
                ...
                <div><label class="control-label FormEventClass" for="email2">Email Address (Optional)</label>
