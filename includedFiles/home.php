...
<!--<script type='text/javascript' src="testLoginScript.js"></script>-->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="home.phph"><i class="fa fa-dashboard"></i> Home</a></li>
            ...
            <div class="inner">
              ...
              <br/>
               <?php
                  ...
                  $db = $dbconn->getDb();
                  $query = "SELECT * FROM event WHERE status='previous' ORDER BY eventDate DESC LIMIT 3";
              ...
              <tr>
                ...
                <?php
                  foreach($prevEvents as $s)
                  {
                    ...
                    echo "<td style='padding-left:2%;width:30%;'>" . $s->eventDate . "</td>";
      ...
      <div class="row" style='margin-top:15px;'>
        ...
        <h2 style='margin-bottom:0px;padding-top:10px;margin-left:30%;'>Next Event</h2>
            ...
            <?php
                  ...
                  $dbconn = new Dbconnect;
                  $db = $dbconn->getDb();
                  $query = "SELECT * FROM event WHERE status='future' ORDER BY eventDate ASC LIMIT 1";
                  $statement = $db->prepare($query);
                  $statement->execute();
        ...
        <section class="col-lg-4 connectedSortable">
          ...
          <!-- Upcoming Events -->
          <div class="box box-solid bg-purple" style='vertical-align:top;margin-left:5%;padding-right:10%;'>
            <div class="box-header">
              <h2 style='font-color:white;padding-bottom:20px;'>Upcoming Events</h2>              
                ...
                <?php
                  ...
                  $dbconn = new Dbconnect;
                  $db = $dbconn->getDb();
                  $query = "SELECT * FROM event WHERE status='future' ORDER BY eventDate ASC";
                  $statement = $db->prepare($query);
                  $statement->execute();
                ...
                <table>
                  ...
                  <?php
                    foreach($newEvents as $p)
                    {
                      ...
                      echo "<td style='width:50%;'>" . $p->eventDate . "</td>";
